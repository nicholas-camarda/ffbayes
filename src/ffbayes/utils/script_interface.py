...
from .interface_standards import (
    get_env_int,
    get_standard_paths,
    handle_exception,
    setup_logger,
...
class StandardizedScriptInterface:
    ...
    def setup_argument_parser(self) -> argparse.ArgumentParser:
        ...
        parser.add_argument(
            '--output-dir', type=str, help='Output directory (overrides default)'
        )
    ...
    def add_data_arguments(
        ...
        parser.add_argument(
            '--data-dir', type=str, help='Data directory (overrides default)'
        )
        ...
        parser.add_argument(
            '--allow-stale-season',
            action='store_true',
            help='Allow the pipeline to continue without the latest expected season',
        )
    ...
    def parse_years(self, years_str: Optional[str]) -> List[int]:
        ...
        try:
            ...
            raise ValueError(
                f'Invalid years format: {years_str}. Expected comma-separated integers.'
            )
    ...
    def validate_monte_carlo_model(
        self, results_df, model_name: str = None
    ) -> Dict[str, Any]:
    ...
    def validate_model_outputs(
        self, outputs: Dict[str, Any], model_name: str = None
    ) -> Dict[str, Any]:
