...
def get_training_years_for_year(projection_year: int) -> List[int]:
    ...
    """
    return get_analysis_years(projection_year)
...
def get_recent_seasons_for_analysis() -> List[int]:
    ...
    """
    return get_analysis_years(CURRENT_YEAR)
